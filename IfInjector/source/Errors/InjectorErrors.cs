...
namespace IfInjector.Errors
{
	...
	{
		// Note to coder
		internal static readonly int MAX_ERROR_CODE = 14;
		...
		public static readonly InjectorError ErrorMustPropertyOrFieldExpression = new InjectorError(14, "Only member expressions of type property or field expression are supported at this time.");
